...
import ru.vlsu.newsportal.repository.EventRepository;
...
class EventResourceIT {
    ...
    void createEvent() throws Exception {
        ...
        assertThat(testEvent.getBody()).isEqualTo(DEFAULT_BODY);
        assertThat(testEvent.getStartAt()).isEqualTo(DEFAULT_START_AT);
        assertThat(testEvent.getFinishedAt()).isEqualTo(DEFAULT_FINISHED_AT);
    ...
    void putNewEvent() throws Exception {
        ...
        updatedEvent.title(UPDATED_TITLE).body(UPDATED_BODY).startAt(UPDATED_START_AT).finishedAt(UPDATED_FINISHED_AT).place(UPDATED_PLACE);
        ...
        assertThat(testEvent.getBody()).isEqualTo(UPDATED_BODY);
        assertThat(testEvent.getStartAt()).isEqualTo(UPDATED_START_AT);
        assertThat(testEvent.getFinishedAt()).isEqualTo(UPDATED_FINISHED_AT);
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.body(UPDATED_BODY);
